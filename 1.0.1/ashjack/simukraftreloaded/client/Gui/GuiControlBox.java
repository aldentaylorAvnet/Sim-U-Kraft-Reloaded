...
public class GuiControlBox extends GuiScreen
{
    ...
    public void actionPerformed(GuiButton guibutton)
    {
        ...
        {
            Building b;
            ModSimukraft.theBuildings.add(b = new Building("Repaired House", "residential", location, location, true));
        ...
        else if (guibutton.displayString.contentEquals("Demolish!"))
        {
            ...
            for (V3 blockLoc : theBuilding.blockLocations)
            {
                ...
                theWorld.setBlock(blockLoc.x.intValue(), blockLoc.y.intValue(), blockLoc.z.intValue(), Blocks.air, 0, 0x03);
