...
public class FolkData implements Serializable
{
   ...
   // public String partneredWith = "";
    ...
    public FolkData(World theWorld)
    {
        ...
        this.trait1 = ModSimukraft.traitList[0].traitName;
    	this.trait2 = ModSimukraft.traitList[1].traitName;
    	this.trait3 = ModSimukraft.traitList[2].traitName;
    	this.trait4 = ModSimukraft.traitList[3].traitName;
        ...
        if (now - timeSinceLastStatusUpdate > 1000)
        {
            ...
            if (System.currentTimeMillis() - timeSinceLastSave > about10)
            {
            	...
            	if (side==Side.SERVER) {
            		...
            		ModSimukraft.network.sendToServer(new UpdateFolkPositionMessage(this.location.toString() + ";" + name));//(new UpdateFolkPositionMessage(this.location.toString() + ";" + name),location.theDimension);
    ...
    private void updateStatusLines()
    {
        ...
        if(this.trait1 == "" || this.trait2 == "" || this.trait3 == "" || this.trait4 == "")
        {
        	//this.trait1 = Traits.traitList[rand.nextInt(7)].traitName;
        	//this.trait2 = Traits.traitList[rand.nextInt(7)].traitName;
        	//this.trait3 = Traits.traitList[rand.nextInt(7)].traitName;
        	//this.trait4 = Traits.traitList[rand.nextInt(7)].traitName;
        	//this.trait1 = "1";
        	//this.trait2 = "2";
        	//this.trait3 = "3";
        	//this.trait4 = "4";
        	//this.trait1 = Traits.traitList[0].traitName;
    ...
    public void gotoXYZ(V3 whereTo, GotoMethod methodOfTravel)
    {
    	...
    	{
    		ModSimukraft.log.info("Is Remote");
    	}
    	if(theEntity.worldObj.isRemote == false)
    	{
    		ModSimukraft.log.info("Is NOT Remote");
    	}*/
