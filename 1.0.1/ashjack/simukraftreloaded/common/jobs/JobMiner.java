                    ...
                    for (int ltr = 0; ltr < theMiningBox.size; ltr++)
                    {
                        ...
                        try
                        {
                            ...
                            if (ftb % 10==0 && btt==Math.floor(theMiningBox.size/2) && ltr==0) {
                            	...
                            	if (miningChests.size() > 0 && lbid !=ModSimukraft.lightBox)
                                {
                                   ItemStack light=null;
                                   int lightmeta=0;
                                   while (light==null && lightmeta <8) {
                                   	light= inventoriesGet(miningChests, new ItemStack(ModSimukraft.lightBox,1,lightmeta), false,true);
                                   	lightmeta++;
                                   }
                                    if (light != null)
                                    {
                            			...
                            			,ModSimukraft.lightBox,light.getItemDamage(),0x03);
                                    }
                                }
                            }
